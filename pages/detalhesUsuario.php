...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-10 titulo-page">
            ...
            ?>
            <h3><i class="fa-solid fa-user"></i><span class="">&emsp;&emsp;Usuário:
                    <?php echo $data['nome']; ?>
                </span></h3>
            <form class="row mt-2">
                <div class="d-flex">
                    ...
                    <div class="col-auto">
                        <label for="staticEmail2" class="visually label-detalhes">Tipo Usuário</label>
                        <input type="text" readonly class="form-control-plaintext" id="staticEmail2"
                            value="<?php echo $data['authority']; ?>">
                    </div>
                </div>
                <div class="d-flex">
                    <div class="col-auto">
